...
sheet.append(["NAVER 뉴스 제목","NAVER 뉴스 본문"])

# WebDriver 객체 생성
driver = webdriver.Chrome()

# 네이버 증권 NAVER 뉴스 페이지 접속
url = "https://m.stock.naver.com/domestic/stock/035420/news/title"
driver.get(url)
...
for idx,news_link in enumerate(news_links):
    ...
    news_count += 1
wb.save(filename='NAVER 기사 스크래핑.xlsx')
driver.quit()