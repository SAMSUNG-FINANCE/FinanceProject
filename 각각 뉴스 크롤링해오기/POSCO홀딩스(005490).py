...
sheet.append(["POSCO홀딩스 뉴스 제목","POSCO홀딩스 뉴스 본문"])

# WebDriver 객체 생성
driver = webdriver.Chrome()

# 네이버 증권 POSCO홀딩스 뉴스 페이지 접속
url = "https://m.stock.naver.com/domestic/stock/005490/news/title"
driver.get(url)
...
wb.save(filename='POSCO홀딩스 기사 스크래핑.xlsx')
driver.quit()