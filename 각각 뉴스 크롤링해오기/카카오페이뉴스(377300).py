...
sheet.append(["카카오페이 뉴스 제목","카카오페이 뉴스 본문"])

# WebDriver 객체 생성
driver = webdriver.Chrome()

# 네이버 증권 카카오페이 뉴스 페이지 접속
url = "https://m.stock.naver.com/domestic/stock/377300/news/title"
driver.get(url)
...
wb.save(filename='카카오페이 기사 스크래핑.xlsx')
driver.quit()