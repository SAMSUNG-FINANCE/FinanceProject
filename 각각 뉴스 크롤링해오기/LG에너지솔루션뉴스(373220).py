...
sheet.append(["LG에너지솔루션 뉴스 제목","LG에너지솔루션 뉴스 본문"])

# WebDriver 객체 생성
driver = webdriver.Chrome()

# 네이버 증권 LG에너지솔루션 뉴스 페이지 접속
url = "https://m.stock.naver.com/domestic/stock/373220/news/title"
driver.get(url)
...
wb.save(filename='LG에너지솔루션 기사 스크래핑.xlsx')
driver.quit()