...
sheet.append(["삼성바이오로직스 뉴스 제목","삼성바이오로직스 뉴스 본문"])

# WebDriver 객체 생성
driver = webdriver.Chrome()

# 네이버 증권 삼성바이오로직스 뉴스 페이지 접속
url = "https://m.stock.naver.com/domestic/stock/207940/news/title"
driver.get(url)
...
wb.save(filename='삼성바이오로직스 기사 스크래핑.xlsx')
driver.quit()