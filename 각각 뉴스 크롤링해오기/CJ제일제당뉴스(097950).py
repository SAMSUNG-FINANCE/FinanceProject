...
sheet.append(["CJ제일제당 뉴스 제목","CJ제일제당 뉴스 본문"])

# WebDriver 객체 생성
driver = webdriver.Chrome()

# 네이버 증권 CJ제일제당 뉴스 페이지 접속
url = "https://m.stock.naver.com/domestic/stock/097950/news/title"
driver.get(url)
...
wb.save(filename='CJ제일제당 기사 스크래핑.xlsx')
driver.quit()