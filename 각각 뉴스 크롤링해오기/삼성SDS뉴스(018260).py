...
sheet.append(["삼성SDS 뉴스 제목","삼성SDS 뉴스 본문"])

# WebDriver 객체 생성
driver = webdriver.Chrome()

# 네이버 증권 삼성SDS 뉴스 페이지 접속
url = "https://m.stock.naver.com/domestic/stock/018260/news/title"
driver.get(url)
...
wb.save(filename='삼성SDS 기사 스크래핑.xlsx')
driver.quit()